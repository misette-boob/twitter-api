...
config :twitter, TwitterWeb.Endpoint,
  ...
  live_view: [signing_salt: "iPkoicOm"]
...
config :twitter, Twitter.Api.Guardian,
  issuer: "twitter",
  secret_key: "Kh8EQX/YVwsCIJZW/PvDnQU2p2W2R7mPLp8xXJrA1rh1c2gbJBGr0CoBCz/oeVOB" #todo move to env
